...
async function playCommand(sock, chatId, message) {
    try {
        ...
        ========================== */
        const apis = [
            `https://api.princetechn.com/api/download/ytmp3?url=${encodeURIComponent(video.url)}`,
            `https://api.princetechn.com/download/audio?url=${encodeURIComponent(video.url)}`
        ];
