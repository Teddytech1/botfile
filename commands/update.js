...
async function updateViaZip(sock, chatId, message, zipOverride) {
    ...
    // const zipUrl = "https://github.com/https://github.com/Teddytech1/botfile/archive/refs/heads/main.zip";
    if (!zipUrl) {
...
async function restartProcess(sock, chatId, message) {
    try {
        ...
        await sock.sendMessage(chatId, { text: '> *TEDDY-XMD Updated completely! Restarting 🔄 and initializating bot data 🚀* ...' }, { quoted: message });
    } catch {}
